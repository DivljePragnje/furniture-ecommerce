...
export const PRODUCT_ADDING_REVIEW_SUCCESS = "PRODUCT_ADDING_REVIEW_SUCCESS";
export const PRODUCT_ADDING_REVIEW_FAIL = "PRODUCT_ADDING_REVIEW_FAIL";

export const PRODUCT_ADDING_RATING_SUCCESS = "PRODUCT_ADDING_RATING_SUCCESS";
export const PRODUCT_ADDING_RATING_FAIL = "PRODUCT_ADDING_RATING_FAIL";
